...
class SafePresentationTester(SafeTester):
    """ General template for safe "Presentation" modules testing """
...
class RiskyPresentationTester(RiskyTester):
    """ General template for risky "Presentation" modules testing """
