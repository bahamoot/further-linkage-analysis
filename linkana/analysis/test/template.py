...
class SafeAnalysisTester(SafeTester):
    """ General template for safe "Analysis" modules testing """
...
class RiskyAnalysisTester(RiskyTester):
    """ General template for risky "Analysis" modules testing """
