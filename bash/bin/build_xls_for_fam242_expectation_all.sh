...
project_name="fam242_expectation_all"
patient_code1=Co441
patient_code2=Co771
patient_code3=Co666
...
#echo -e "ExonicFunc\tcount" > $out_common_mutations_csv
#cut -f3 $tmp_common_mutations_csv | sort | uniq -c | grep -v Func | awk '{ printf "%s\t%s\n", substr($0,9,60), substr($0,1,7)}' >> $out_common_mutations_csv
